...
const TREVO_SVG = (size=34) => `<svg viewBox="0 0 40 40" width="${size}" height="${size}" style="vertical-align:middle" aria-hidden="true"><path d="M20 21 q3 8 -2 16" stroke="#9096a0" stroke-width="2.6" fill="none" stroke-linecap="round"/><circle cx="14.5" cy="14.5" r="9" fill="#0071bc"/><circle cx="25.5" cy="14.5" r="9" fill="#39b54a"/><circle cx="14.5" cy="25.5" r="9" fill="#ffce00"/><circle cx="25.5" cy="25.5" r="9" fill="#f7941e"/></svg>`;
