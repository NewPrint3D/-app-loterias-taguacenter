...
// Trevo multicolorido das Loterias Caixa (4 folhas, cada uma de uma cor) — usado como ícone das loterias.
const TREVO_SVG = (size=34) => { const P='M20,20 C14,12 8,12.5 8,7.5 C8,4 11,1.5 14.5,1.5 C17,1.5 19,3 20,5.2 C21,3 23,1.5 25.5,1.5 C29,1.5 32,4 32,7.5 C32,12.5 26,12 20,20 Z'; return `<svg viewBox="0 0 40 40" width="${size}" height="${size}" style="vertical-align:middle" aria-hidden="true"><path d="M20 20 q4.5 9 -0.5 17.5" stroke="#8a8f96" stroke-width="2.3" fill="none" stroke-linecap="round"/><path d="${P}" fill="#0071bc" transform="rotate(315 20 20)"/><path d="${P}" fill="#39b54a" transform="rotate(45 20 20)"/><path d="${P}" fill="#f7941e" transform="rotate(135 20 20)"/><path d="${P}" fill="#ffce00" transform="rotate(225 20 20)"/></svg>`; };
      ...
      <div class="grid-lt">
        ${Object.values(LOTERIAS).map(lt=>{
          return`<div class="lt-card" style="background:linear-gradient(135deg,${lt.cor},${lt.cor2})${lt.corTexto?`;--lt-txt:${lt.corTexto};--lt-shadow:none`:''}" onclick="R._ltClick('${lt.id}')">
            <span class="lt-emoji">${TREVO_SVG(34)}</span>
