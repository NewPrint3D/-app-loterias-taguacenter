...
// Cores seguem a paleta oficial das loterias da Caixa (cor = base do card, cor2 = tom mais escuro
// para o degradê). Ícone de todas = trevo 🍀 (marca das Loterias Caixa).
// Super Sete (7 colunas 0-9) e +Milionária (6 dezenas + 2 trevos) têm formato próprio — ver flags
// `colunas`/`trevos`.
const LOTERIAS = {
  ...
  quina:         { id:'quina',         nome:'Quina',        emoji:'🍀', dezenas:5,  max:80,  preco:2.50, cor:'#260085', cor2:'#14004a', api:'quina',         dias:'Segunda a Sábado' },
  lotofacil:     { id:'lotofacil',     nome:'Lotofácil',    emoji:'🍀', dezenas:15, max:25,  preco:3.00, cor:'#930989', cor2:'#4f0049', api:'lotofacil',     dias:'Segunda a Sábado' },
  ...
  timemania:     { id:'timemania',     nome:'Timemania',    emoji:'🍀', dezenas:10, max:80,  preco:3.50, cor:'#f5c518', cor2:'#8a6d0a', corTexto:'#4a2e08', api:'timemania',     dias:'Ter, Qui e Sáb' },
...
const TEMAS = {
  ...
  mega_virada:   { id:'mega_virada',   nome:'Mega da Virada',             emoji:'🎆', desc:'31 de Dezembro · Ano Novo',    decos:[], fogos:'Feliz 2027', cores:{ bg:'#08080f', bg2:'#101026', bg3:'#18183a', primary:'#FFD700', gold:'#ff9500', border:'#2a2a55' } },
  ...
  natal:         { id:'natal',         nome:'Natal',                      emoji:'🎄', desc:'Dezembro · Feliz Natal',       decos:['❄️'], fogos:'Feliz Natal', cores:{ bg:'#0a160a', bg2:'#0f220f', bg3:'#152e15', primary:'#2ecc71', gold:'#FFD700', border:'#1a5a1a' } },
